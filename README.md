...
<div align="center">
  ...
  <h2 align="center">Scroll-Parallax</h2>
...
To run **Scroll-Parallax** locally, run this command on your git bash:

Linux and macOS:

```bash
sudo git clone https://github.com/Asifmohamed007/Scroll-Parallax.git
```

Windows:

```bash
git clone https://github.com/Asifmohamed007/Scroll-Parallax.git
```
